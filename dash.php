      ...
      <ul class="nav navbar-nav">
		...
		<li class="dropdown <?php if(@$_GET['q']==2 || @$_GET['q']==3) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=3">Ranking Chart</a></li>
          </ul>
        </li>
		<li <?php if(@$_GET['q']==4) echo'class="active"'; ?>><a href="dash.php?q=4">See Tickets</a></li>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>University</b></td><td><b>Score</b></td></tr>';
$c=0;
...
if(@$_GET['q']==3){
echo '<a class="btn sub" href="chart.html">Ranking Chart</a>';
}
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>University</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
while($row = mysqli_fetch_array($result)) {
	...
	$id = $row['id'];
	 echo '<tr><td>'.$c++.'</td>';
	echo '<td><a title="Click to open feedback" href="dash.php?q=4&fid='.$id.'">'.$subject.'</a></td><td>'.$email.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
	<td><a title="Open Feedback" href="dash.php?q=4&fid='.$id.'"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
